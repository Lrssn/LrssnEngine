...
LE_VULKAN_VERSION = '1.2.170.0'
VULKAN_SDK_EXE_PATH = 'LrssnEngine/vendors/VulkanSDK/VulkanSDK.exe'
...
def CheckVulkanSDK():
    if (VULKAN_SDK is None):
        ...
        InstallVulkanPrompt()
        return False
    elif (LE_VULKAN_VERSION not in VULKAN_SDK):
        print(f"Located Vulkan SDK at {VULKAN_SDK}")
        print(f"You don't have the correct Vulkan SDK version! (LrssnEngine requires {LE_VULKAN_VERSION})")
        InstallVulkanPrompt()
        return False
...
OutputDirectory = "LrssnEngine/vendors/VulkanSDK"
