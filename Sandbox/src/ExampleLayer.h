...
public:
	ExampleLayer()
		...
		LrssnEngine::Ref<LrssnEngine::VertexBuffer> vertexBuffer = LrssnEngine::VertexBuffer::Create(vertices, sizeof(vertices));
		...
		LrssnEngine::Ref<LrssnEngine::IndexBuffer> indexBuffer = LrssnEngine::IndexBuffer::Create(indices, sizeof(indices) / sizeof(uint32_t));
		...
		LrssnEngine::Ref<LrssnEngine::VertexBuffer> squareVB = LrssnEngine::VertexBuffer::Create(squareVertices, sizeof(squareVertices));
		squareVB->SetLayout({
			{ LrssnEngine::ShaderDataType::Float3, "a_Position" },
		...
		LrssnEngine::Ref<LrssnEngine::IndexBuffer> squareIB = LrssnEngine::IndexBuffer::Create(squareIndices, sizeof(squareIndices) / sizeof(uint32_t));
